...
export default function InProgressTasks() {
  ...
  if (loading)
    return <p className="text-center mt-8">Loading in-progress tasks...</p>;
  if (error)
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="p-6 bg-white shadow-lg rounded-xl">
        ...
        <div className="flex items-center space-x-3 mb-6">
          <FontAwesomeIcon
            icon={faTasks}
            className="text-orange-600 h-8 w-8 animate-pulse"
          />
          <h1 className="text-3xl font-bold text-gray-800">In Progress Tasks</h1>
        </div>
